...
bool read_HTS221_temperature(int16_t* result_ptr) {
	...
	zaehler = ((hts221.hts221_cal_data.T1_degC - hts221.hts221_cal_data.T0_degC)*(t_out - hts221.hts221_cal_data.T0_OUT));
	nenner = (hts221.hts221_cal_data.T1_OUT - hts221.hts221_cal_data.T0_OUT);
	temperature_result = (zaehler/nenner) + ( hts221.hts221_cal_data.T0_degC);
...
//	#endif
	...
	zaehler = ((hts221.hts221_cal_data.H1_rH - hts221.hts221_cal_data.H0_rH)*(h_t_out - hts221.hts221_cal_data.H0_T0_OUT));
	nenner = (hts221.hts221_cal_data.H1_T0_OUT - hts221.hts221_cal_data.H0_T0_OUT);
	
	humidity_result = (zaehler/nenner) + (hts221.hts221_cal_data.H0_rH);
